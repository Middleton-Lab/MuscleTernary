...
To create a ternary plot from origin and insertion data, first we need data. Attachment centroid data are available for the AL_008 specimen of *Alligator mississippiensis* (although similar data can be extracted directly from stl files; see the "Working with stl files" vignette).
